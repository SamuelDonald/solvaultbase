      ...
      <div className="flex min-h-full items-start justify-center py-4 sm:items-center sm:py-6">
        <div className="glass w-full max-w-5xl rounded-3xl border border-accent/20 p-5 shadow-2xl sm:p-7">
          ...
          <div className="space-y-5">
            ...
            <div className="max-h-[60vh] min-h-[320px] overflow-hidden rounded-2xl">
            ...
            <div className="flex flex-wrap items-center gap-3">
              ...
              <Button
                variant="ghost"
                onClick={() => {
                  localStorage.removeItem("solbase-vault-simulation");
              ...
              <span className="text-xs text-muted-foreground">
                Current simulated price: {state.currentSol.toFixed(4)} SOL
              </span>
            </div>
